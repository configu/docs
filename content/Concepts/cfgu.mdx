...
- **options**: Specifies a list of values that the configuration value must match. This property is optional.
- **schema**: Specifies a [JSON-schema](https://json-schema.org/specification) that the configuration value must match. This property is optional and applicable when the type is set to JSONSchema.
