...
The Export command in the SDK supports an optional `keys` parameter that allows you to mutate the configuration keys according to your requirements by providing a callback function with this signature: `(key: string) => string`.
