  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          - <a href="https://github.com/configu/configu/blob/main/types/Config.ts" target="_blank">See Config decleration in code</a>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          - <a href="https://github.com/configu/configu/blob/main/types/Cfgu.ts" target="_blank">See Cfgu decleration in code</a>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          - <a href="https://github.com/configu/configu/blob/main/types/ConfigSchema.ts" target="_blank">See ConfigSchema decleration in code</a>
      ...
      <tr>
        ...
        <td>
          - <a href="https://github.com/configu/configu/blob/main/types/ConfigSet.ts" target="_blank">See ConfigSet decleration in code</a>
      ...
      <tr>
        ...
        <td>
          - <a href="https://github.com/configu/configu/blob/main/types/ConfigStore.ts" target="_blank">See ConfigStore decleration in code</a>
