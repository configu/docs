...
### Congiguration Source

It is a place where the Configu tool can go to find configuration properties.

### Configuration Provider

It is a component that the Configu tool uses to load configuration properties from a configuration source.
