...
<pre>
  <code>
    {getStoreConnectionStringPlaceholder('configu')}
      <br />
      {getStoreConnectionStringPlaceholder('json-file')}
      <br />
      {getStoreConnectionStringPlaceholder('sqlite')}
      <br />
      {getStoreConnectionStringPlaceholder('postgres')}
      <br />
  </code>
</pre>
