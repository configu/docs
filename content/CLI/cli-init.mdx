...
create a new [ConfigSchema `.cfgu`](/docs/config-schema) file in the current working dir.
...
- `--uid <string>` (**optional**) set the schema `uid`, which is also the name of the new .cfgu file. the default is the current directory name in parameter-case.
