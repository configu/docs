...
Integrates the Configu Orchestrator with a [MySQL](https://dev.mysql.com/doc) database.

## Initialization

Configu needs to be authorized to access your database instance. View the configuration options [here](https://typeorm.io/data-source-options#mysql--mariadb-data-source-options).
