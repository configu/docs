...
Integrates the Configu Orchestrator with a SQLite database.
...
View additional configuration options [here](https://typeorm.io/data-source-options#better-sqlite3-data-source-options).
