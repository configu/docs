...
Integrates the Configu Orchestrator with a [Microsoft SQL Server](https://learn.microsoft.com/en-us/sql/sql-server) database.

## Initialization

Configu needs to be authorized to access your database instance. View the configuration options [here](https://typeorm.io/data-source-options#mssql-data-source-options).
