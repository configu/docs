...
Members and tokens can be assigned a config attribute which gives them access to a specific config within a config set.
...
- Only members can be assigned config attributes, tokens cannot.
