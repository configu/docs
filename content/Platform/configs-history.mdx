...
Pic of explore tag action

This will take you to the explorer tab where you will see the snapshot of the the tag and you can utilize the existing features of the tab to explore it. At any point you can exit the exploration mode by clicking `return to latest tag` in the banner at the top of the page.

pic of explore

- note view constraints
- note authorization still being in effect
