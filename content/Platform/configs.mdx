...
The Configs Compare feature simplifies the process of comparing configurations between two [sets](/config-set) in your organization.
...
![image](./img/configs/configs-compare-sets.png)
