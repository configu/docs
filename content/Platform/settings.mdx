...
For stricter access control, owners can define protected sets via the Settings page. Any mutation of protected sets within the organization will trigger change requests that are queued for approval by an admin.
...
Mutations of protected sets create a `Upsert Config Request` [audit](../audit) entry.
