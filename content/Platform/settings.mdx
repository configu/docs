...
For stricter access control, owners can define protected sets via the Settings page. Only admins can directly mutate protected sets. Non-admins that perform upserts on protected sets within the organization will have their changes queued for approval by an admin.
