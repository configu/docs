...
<Admonition type="info">Software = Code(logic) + Configurations(behavior)</Admonition>
...
<Admonition type="info">Today(configuration management) = Pre-Github(code management)</Admonition>
