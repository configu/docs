...
**Configu** is a _simple_, _modern_, and _generic_ standard for managing and collaborating **software configurations ⚙️**. It is built to provide a _common_, _flexible_, and _extensible_ process for _storing_, _mutating_, and _orchestrating_ **configuration data** across different environments and systems.
...
<CollapsibleItem title="Collapsible title 1" isOpen>
    If you would like to contribute code to Configu or provide feedback, we welcome you to join our [Discord channel](https://discord.com/invite/cjSBxnB9z8)
</CollapsibleItem>

<CollapsibleItem title="Collapsible title 2">
    If you would like to contribute code to Configu or provide feedback, we welcome you to join our [Discord channel](https://discord.com/invite/cjSBxnB9z8) or reach out via email at <a href="mailto:support@configu.com">support@configu.com</a>.
</CollapsibleItem>
...
<div className="rounded bg-white">![motivation](background-banner.svg)</div>

In the software development lifecycle, developers usually extract some of the configuration items or metadata of the application from the code and manage them in a separate location, such as a configuration file. This separately managed content is called _application configuration_, and is an important aspect of software development, as it allows developers to customize the behavior of their applications to meet the needs of different users and environments. This can include things such as environment variables, secrets, feature flags, and any other data that is used to configure the behavior of an application.

## Motivation

<div className="rounded bg-white">![motivation](motivation-banner.svg)</div>
