...
<CollapsibleItem title="What is the difference between secret managers, feature flag solutions and Configu?">
...
<CollapsibleItem title="Can I use other products to store my configurations with Configu (e.g. Git repository, ASM, Hashicorp Vault)?">
...
<CollapsibleItem title="Can I fetch configurations with Configu if I'm offline?">
...
<CollapsibleItem title="Is there a free version of Configu?">
