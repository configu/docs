...
Configu Cloud complements the [Configu Orchestrator](/configu-orcastrator) management by providing:

- [A Single Source Of Truth](/configs) - with an easy way to explore and modify configurations
- **Testing** - beyond the [Configu Orchestrator](/configu-orcastrator) tests, Configu Cloud adds a logic test layer that tests the big picture
- [History & Versioning](/configs/#configs-history) - records configuration changes, making it easy to revert if needed
...
- [Permissions](/settings/#organization-members) - invite team members and control their permissions
