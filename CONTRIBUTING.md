...
Markdown files for the documentation are located in [`src/content/docs`](./content/docs) folder. The URL structure is generated by page frontmatter `slug` field.

Sidebar data is stored in the [`src/content/docs/sidebar.json`](./content/docs/sidebar.json) file.
